...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  useEffect( () => {
      if(Object.keys(paciente).length > 0) { /* Detecta que el objeto paciente sea igual a 0 */
  ...
  // Como generar un ID en base a un numero aleatorio sumado a la fecha de ese momento.
  const generarId = () => {
